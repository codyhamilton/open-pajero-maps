...
- **Scope (user, 2026-09-20):** this design covers WP1 map-layer remediation only. The WP2/WP3 spikes are documented as unknowns in `docs/ARCHITECTURE.md`, not designed here.
