...
passes (`roundtrip_idx.py`) explicitly left open: computing brand-new offsets for every
...
Allocation rule discovered: every reachable byte in SADSR201.IDX from
...
unexplained gaps anywhere in the reachable tree.
...
# EVERY record, not just a sample -- Any
