...
3. Assign each node its "uppermost identical level" (2/4/6/8) from its
   ...
   higher levels sparser, exactly like the real disc.
...
"KNOWN LIMITATIONS" list near the bottom of this file for what's proven vs. assumed.
"""
...
#: this module's region-hierarchy study
...
def mark_boundary_and_build_rpgraph(fg: FlatGraph, region: RegionNode,
    ...
    best-supported reading found, not
...
#   during the region-hierarchy study,
